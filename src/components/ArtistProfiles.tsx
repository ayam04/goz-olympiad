...
const SubscriberBackgroundsIcon = styled.img`width: 200px;
height: 200px;
position: relative;
...
`;
const SubscriberDetails = styled.div`display: flex;
...
`;
const ArtistProfilesRoot = styled.div`flex: 1;
width: 100%;
position: relative;
display: flex;
flex-direction: column;
...
const :FunctionComponent = ({ className="" }) => {
  return (
    <ArtistProfilesRoot className={className}>
      <SubscriberBackgroundsIcon loading="lazy" alt="" src="/rectangle-2-21@2x.png" />
      <SubscriberDetails>
