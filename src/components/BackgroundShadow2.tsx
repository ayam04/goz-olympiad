...
`;
const DirectChat = styled.div`position: relative;
line-height: 24px;
...
justify-content: flex-start;
padding: 0px var(--padding-14xl) var(--padding-12xs-5) 0px;
box-sizing: border-box;
width: auto;
align-self: unset;
gap: var(--gap-0);
...
const :FunctionComponent = ({ className="" }) => {
  return (
    <BackgroundshadowRoot className={className}>
      <BackgroundWrapper>
        <BackgroundIcon loading="lazy" alt="" src="/background2.svg" />
      </BackgroundWrapper>
      <FrameParent>
        <ContainerParent>
          <Container>
            <DirectChat>Direct Chat</DirectChat>
          </Container>
          <Div>13,921</Div>
        </ContainerParent>
        <HorizontalDivider1>
        ...
        <Container1>
          <IncreaseIn>50% Increase in…</IncreaseIn>
        </Container1>
      </FrameParent>
