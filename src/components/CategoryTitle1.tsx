...
`;
const SufyanAli = styled.a`text-decoration: none;
position: relative;
...
`;
const ListenAgain = styled.a`text-decoration: none;
position: relative;
...
`;
const CategoryTitleRoot = styled.div`width: 203px;
position: relative;
display: flex;
flex-direction: row;
align-items: flex-start;
...
const :FunctionComponent = ({ className="" }) => {
  return (
    <CategoryTitleRoot className={className}>
      ...
      <SufyanAliParent>
        <SufyanAli>Sufyan Ali</SufyanAli>
