...
`;
const LookingForLove = styled.b`width: 121px;
position: relative;
...
const :FunctionComponent = ({ className="" }) => {
  return (
    <RectangleParentRoot className={className}>
      <InstanceChild alt="" src="/rectangle-24@2x.png" />
      <FrameWrapper>
        <LookingForLoveLeeDaggerDParent>
          <LookingForLove>Hey, Soul Sister</LookingForLove>
          <ListenAgainParent>
            <ListenAgain>Sam Smith</ListenAgain>
            <EllipseWrapper>
              <FrameChild />
            </EllipseWrapper>
