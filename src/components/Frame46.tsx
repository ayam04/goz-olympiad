...
`;
const LookingForLove = styled.b`width: 141px;
position: relative;
...
const :FunctionComponent = ({ className="" }) => {
  return (
    <RectangleParentRoot className={className}>
      <InstanceChild alt="" src="/rectangle-21@2x.png" />
      <FrameWrapper>
        <LookingForLoveLeeDaggerDParent>
          <LookingForLove>Someone Like You</LookingForLove>
          <ListenAgainParent>
            <ListenAgain>Elton John</ListenAgain>
            <EllipseWrapper>
              <FrameChild />
            </EllipseWrapper>
