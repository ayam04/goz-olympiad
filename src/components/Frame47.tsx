...
`;
const LookingForLove = styled.b`width: 51px;
position: relative;
...
`;
const ListenAgainParent = styled.div`width: 430px;
display: flex;
flex-direction: row;
align-items: flex-start;
justify-content: flex-start;
...
const :FunctionComponent = ({ className="" }) => {
  return (
    <RectangleParentRoot className={className}>
      <InstanceChild loading="lazy" alt="" src="/rectangle-2-8@2x.png" />
      <FrameWrapper>
        <LookingForLoveLeeDaggerDParent>
          <LookingForLove>Royals</LookingForLove>
          <ListenAgainParent>
            <ListenAgain>Florence Welch (of Florence + the Machine)</ListenAgain>
            <EllipseWrapper>
              <FrameChild />
            </EllipseWrapper>
