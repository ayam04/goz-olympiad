...
`;
const LookingForLove = styled.b`width: 35px;
position: relative;
...
const :FunctionComponent = ({ className="" }) => {
  return (
    <RectangleParentRoot className={className}>
      <InstanceChild alt="" src="/rectangle-23@2x.png" />
      <FrameWrapper>
        <LookingForLoveLeeDaggerDParent>
          <LookingForLove>Halo</LookingForLove>
          <ListenAgainParent>
            <ListenAgain>Ellie Goulding</ListenAgain>
            <EllipseWrapper>
              <FrameChild />
            </EllipseWrapper>
