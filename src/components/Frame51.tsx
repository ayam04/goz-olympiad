...
`;
const LookingForLove = styled.b`width: 58px;
position: relative;
...
`;
const ListenAgainParent = styled.div`width: 324px;
flex: 1;
display: flex;
flex-direction: row;
align-items: flex-start;
...
const :FunctionComponent = ({ className="" }) => {
  return (
    <RectangleParentRoot className={className}>
      <InstanceChild loading="lazy" alt="" src="/rectangle-2-12@2x.png" />
      <FrameWrapper>
        <LookingForLoveLeeDaggerDParent>
          <LookingForLove>Havana</LookingForLove>
          <ListenAgainParent>
            <ListenAgain>Annie Lennox (of Eurythmics)</ListenAgain>
            <EllipseWrapper>
              <FrameChild />
            </EllipseWrapper>
