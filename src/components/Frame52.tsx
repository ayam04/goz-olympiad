...
`;
const LookingForLove = styled.b`width: 174px;
position: relative;
...
`;
const ListenAgainParent = styled.div`width: 365px;
display: flex;
flex-direction: row;
align-items: flex-start;
justify-content: flex-start;
...
const :FunctionComponent = ({ className="" }) => {
  return (
    <RectangleParentRoot className={className}>
      <InstanceChild loading="lazy" alt="" src="/rectangle-2-13@2x.png" />
      <FrameWrapper>
        <LookingForLoveLeeDaggerDParent>
          <LookingForLove>Can't Stop the Feeling!</LookingForLove>
          <ListenAgainParent>
            <ListenAgain>Calvin Harris (singer and producer)</ListenAgain>
            <EllipseWrapper>
              <FrameChild />
            </EllipseWrapper>
