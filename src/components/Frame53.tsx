...
`;
const LookingForLove = styled.b`width: 64px;
position: relative;
...
`;
const ListenAgain1 = styled.div`flex: 1;
position: relative;
letter-spacing: -0.01em;
display: flex;
min-width: 92;
...
`;
const ListenAgainParent = styled.div`width: 203px;
display: flex;
flex-direction: row;
align-items: flex-start;
justify-content: flex-start;
...
const :FunctionComponent = ({ className="" }) => {
  return (
    <RectangleParentRoot className={className}>
      <InstanceChild alt="" src="/rectangle-2@2x.png" />
      <FrameWrapper>
        <LookingForLoveLeeDaggerDParent>
          <LookingForLove>Stitches</LookingForLove>
          <ListenAgainParent>
            <ListenAgain>Peter Gabriel</ListenAgain>
            <EllipseWrapper>
              <FrameChild />
            </EllipseWrapper>
