...
const Landscape11jpgIcon = styled.img`height: 50px;
width: 50px;
position: relative;
...
`;
const MacbookAir = styled.div`position: relative;
line-height: 21px;
display: flex;
min-width: 86;
width: auto;
...
`;
const MacbookAirParent = styled.div`align-self: stretch;
display: flex;
flex-direction: row;
align-items: flex-start;
...
`;
const MakeBigThings = styled.div`position: relative;
line-height: 18px;
display: flex;
width: auto;
align-self: unset;
...
const :FunctionComponent = ({ className="" }) => {
  return (
    <ItemRoot className={className}>
      <Landscape11jpgIcon loading="lazy" alt="" src="/landscape1jpg1@2x.png" />
      <FrameParent>
        <MacbookAirParent>
          <MacbookAir>MacBook Air</MacbookAir>
          <Background>
            <Div>$450</Div>
          </Background>
        </MacbookAirParent>
        <Container>
          <MakeBigThings>Make big things happen. All day long.</MakeBigThings>
        </Container>
      </FrameParent>
    </ItemRoot>);
};
